...
namespace Polydraw 
{
    ...
    public class PolydrawObject : MonoBehaviour
    {
        ...
        public void Refresh()
        {
            ...
            bool isTrigger = gameObject.GetComponent<Collider>() == null
                ? false
                : gameObject.GetComponent<Collider>().isTrigger;
            bool isConvex = gameObject.GetComponent<MeshCollider>() == null
                ? false
                : gameObject.GetComponent<MeshCollider>().convex;
        ...
        private const float BOX_COLLIDER_SIZE = .1f;
